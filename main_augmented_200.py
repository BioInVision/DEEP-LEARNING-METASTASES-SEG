...
# with open('/home/yxl1214/mets_segment/shuffled_train_valid_data_Otsu_multiplier_200.p3', 'rb') as f:
...
# 
# with open('/home/yxl1214/mets_segment/shuffled_train_valid_GFP_Otsu_multiplier_200.p3', 'wb') as f:
...
batch_size = 8
train_datagen = customImageDataGenerator(rotation_range=90,
...
val_datagen = customImageDataGenerator(rotation_range=90,
                                       horizontal_flip=True,
                                       vertical_flip=True,
                                       zoom_range=0.1,
                                       rescale = 1/255,
...
# model.load_weights('/home/yxl1214/mets_segment/CNN_augment_weight20_LR1e-5_size200.hdf5')

model_checkpoint = ModelCheckpoint('/home/yxl1214/mets_segment/CNN_augment_weight20_LR1e-5_size200.hdf5', monitor='val_acc',
                                   verbose=1, save_best_only=True)

# ---------------------- augmented fit_generator-------------------------
# model = load_model('/home/yxl1214/mets_segment/CNN_augment_weight20_LRe-5_size200.hdf5')
...
# save history
with open('/home/yxl1214/mets_segment/trainHistoryDict_augment_weight20_size200.p3', 'wb') as file_pi:
    pickle.dump(history.history, file_pi, protocol=4)

# save model
model.save('/home/yxl1214/mets_segment/softmax_layer3_augment_weight20_LR1e-5_batch8_size200.h5')
