...
# 
# with open('/home/yxl1214/mets_segment/shuffled_train_valid_GFP_Otsu_multiplier_400.p3', 'wb') as f:
...
model_checkpoint = ModelCheckpoint('/home/yxl1214/mets_segment/new_CNN_batch8_weight20_LRe-5_size400.hdf5', monitor='val_acc',
...
# save history
with open('/home/yxl1214/mets_segment/trainHistoryDict_augment_weight20_size400.p3', 'wb') as file_pi:
    pickle.dump(history.history, file_pi, protocol=4)

# save model
model.save('/home/yxl1214/mets_segment/softmax_layer3_augment_weight20_LR1e-5_batch8_size400.h5')
